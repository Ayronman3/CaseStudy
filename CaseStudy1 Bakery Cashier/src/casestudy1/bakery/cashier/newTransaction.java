        ...
        while(control){
            ...
            while(control2){
                ...
                // Item is not available
                    ...
                    System.out.println("Sorrry. " + products[itemNum] + " is currently not available.");
            ...
            if(itemQuant  != 0){
                ...
                if(Void == 1){
                    ...
                    System.out.println("Which Item Do You Want To Be Reomoved? (Please Enter the NAME of the Product");
                    String productVoid = sc.nextLine();
                    /*
                    int getIndx = sc.nextInt();
                    String productVoid = String.valueOf(list.get(getIndx-1));
                    System.out.println(productVoid);
                    */
                    if(list.contains(productVoid)){
                        productIndex = list.indexOf(productVoid);
                    }
                    int voidedItem = Integer.valueOf(list.get(productIndex + 1).toString());
                    System.out.println(voidedItem);
                    System.out.println(Integer.valueOf(list.get(productIndex+3).toString()));
                    quantity[voidedItem] = quantity[voidedItem] +  Integer.valueOf(list.get(productIndex+3).toString());
                    list.subList(productIndex, productIndex+5).clear();
                    System.out.println(productVoid + " has been removed from your orders");
